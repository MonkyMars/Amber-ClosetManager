...
export const CLOTHING_CATEGORIES: Record<string, ClothingCategory> = {
  ...
  sweater: {
    ...
    maxPerOutfit: 1,
    priority: 6,
    conflicts: ["hoodie", "sweatshirt", "tops"],
  },
  hoodie: {
    name: "hoodie",
    type: "layer",
    maxPerOutfit: 1,
    priority: 5,
    conflicts: ["vest", "blazer", "cardigan", "sweater", "tops"],
  },
  sweatshirt: {
    name: "sweatshirt",
    type: "base",
  ...
  vest: {
    ...
    maxPerOutfit: 1,
    priority: 4,
    conflicts: ["hoodie", "jacket", "blazer", "tops", "dress", "jumpsuit"],
  },
  blazer: {
    name: "blazer",
    type: "layer",
  ...
  coat: {
    ...
    maxPerOutfit: 1,
    priority: 7,
    conflicts: ["jacket", "vest", "hoodie", "blazer"],
  },
  "leather-jacket": {
    name: "leather-jacket",
    type: "outer",
