							...
							<div className="space-y-4">
								...
								<div className="flex gap-2 pt-2">
									<button
										...
										className="flex-1 flex items-center justify-center gap-2 text-sm bg-purple-50 text-purple-700 px-4 py-2 rounded-lg hover:bg-purple-100 transition-colors"
									>
										<Sparkles className="w-4 h-4" />
										Generate Outfit
									</button>
									<button className="flex items-center justify-center gap-2 text-sm bg-gray-50 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-100 transition-colors">
							...
							<div className="space-y-6">
								<div className="flex items-center justify-between">
									<div>
										...
										<p className="text-gray-600">Generated outfit suggestions</p>
									</div>
									<button
								...
								{generatingOutfit ? (
									<div className="flex items-center justify-center py-12">
										<LoadingSpinner />
										<span className="ml-3 text-gray-600">Generating perfect outfit...</span>
									</div>
								) : (
